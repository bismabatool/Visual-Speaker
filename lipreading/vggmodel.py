...
def create_model(img_width, img_height):
    ...
    model.add(Convolution2D(64, (3, 3), activation='relu', name='conv1_1', padding='same'))
    ...
    model.add(ZeroPadding2D((1, 1)))
    model.add(Convolution2D(512, (3, 3), activation='relu', name='conv5_1',  padding='same'))
    model.add(ZeroPadding2D((1, 1)))
    model.add(Convolution2D(512, (3, 3), activation='relu', name='conv5_2',  padding='same'))
    model.add(ZeroPadding2D((1, 1)))
    model.add(Convolution2D(512, (3, 3), activation='relu', name='conv5_3',  padding='same'))
    model.add(MaxPooling2D((2, 2), strides=(2, 2)))
    ...
    # with l2 regularizer
    top_model.add(Dense(4096, activation='relu', kernel_regularizer=l2(0.1)))
    # drop out layer
