...
def align_face_and_resize_frames():
	...
	for f in ['30.jpg','28.jpg','26.jpg','24.jpg','22.jpg','20.jpg','18.jpg','16.jpg','14.jpg','12.jpg','10.jpg','8.jpg','6.jpg','4.jpg','2.jpg','2.jpg']:
	    img_index +=1
...
while True:
	...
	path = "'images/00/IMG_8840"
	vs = WebcamVideoStream('data/00/IMG_8840.MOV').start()
	fps = FPS().start()
	record_index=30
	...
	while fps._numFrames < args["num_frames"]:
		...
		if record_index>0:
			if record_index%2==0:
				cv2.imwrite("images/"+str(record_index)+".jpg", frame)
			else:
	...
	# conc.concate_images(path) # concate 15 images under folder result_lip
	#
	# #sleep for 1 s
	# time.sleep(1)
